...
class VerifierServer(Server):
    ...
    def _attestation_routes(self):
        ...
        self._get(
            "/agents/:agent_id/attestations/latest", PushAttestationController, "show_latest", allow_insecure=True
        )
        self._patch(
            "/agents/:agent_id/attestations/latest", PushAttestationController, "update_latest", allow_insecure=True
        )
